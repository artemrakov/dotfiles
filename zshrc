...
plugins=(git gitfast last-working-dir common-aliases zsh-syntax-highlighting history-substring-search z docker docker-compose)
...
source "./docker-machine-wrapper.sh"
